...
public class OperacionLogica extends Instruccion {
    ...
    public OperacionLogica(Instruccion Nodo1, Instruccion Nodo2, TipoOperacion tipo) {
        this.Nodo1 = Nodo1;
        this.Nodo2 = Nodo2;
        this.tipo = tipo;
    }

    private void OperarLog(Instruccion No1, Instruccion No2) {
        if (tipo == TipoOperacion.AND) {
            ...
            System.out.println("Tipos no manejados : " + No1.valor.getClass() + " y " + No2.valor.getClass());
            textAreaGG2.setText("Tipos no manejados: " + No1.valor.getClass() + " y " + No2.valor.getClass());
            Erroor error =  new Erroor("Semantico", "Tipos no manejados  : " ,No1.valor.getClass() + " y " + No2.valor.getClass(),0, 0);
            ErrorList.add(error);
        }
    }
